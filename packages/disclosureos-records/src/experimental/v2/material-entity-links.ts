import { type MaterialEntity } from "./material-entities-schema";
import {
  ArchivalEntitySchema,
  type ArchivalEntity,
} from "./archival-entities-schema";
import { researchEntityAssertions } from "./entity-document-validation";
...
export function checkMaterialEntityLinks(
  entries: readonly (readonly [number, MaterialEntity])[],
  initialUnchecked: readonly string[],
) {
  ...
  return { issues, uncheckedRefs: [...unchecked] };
}
