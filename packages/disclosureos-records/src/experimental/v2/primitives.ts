...
export const instantString = z.iso.datetime({ offset: true }).regex(/^(?!0000)/)
...
export function comparePoints(start: EventTimePoint, end: EventTimePoint): number {
...
export function checkTime(value: EventTimeValue, path: string, issues: PrimitiveIssue[]): void {
